...
def saveimages(tmp):
    ...
    for n in range(80, 100):
        ...
        matplotlib.image.imsave('./fat2/%sdata%d.jpg' % (filenumb,n), plane, cmap="gray", vmin=mini, vmax=maxi)
    ...
    for n in range(80, 100):
        ...
        plane = plane.reshape(x, z)
        matplotlib.image.imsave('./liver2/%sdata%d.jpg' % (filenumb,n), plane, cmap="gray")
