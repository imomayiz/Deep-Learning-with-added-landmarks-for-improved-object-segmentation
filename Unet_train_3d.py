...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.max_pool_2x2 = nn.MaxPool3d(kernel_size=(2,1,2), stride=(2,1,2))
...
# load vtk fat data
filename = "../../Project course/500017_fat_content.vtk"
...
filename = "../../Project course/binary_liver500017.vtk"
reader = vtk.vtkGenericDataObjectReader()
reader.SetFileName(filename)
reader.Update()
data = vtk_to_numpy(reader.GetOutput().GetPointData().GetScalars())
...
for epoch in range(1000):
    ...
    for batch in range(85,90):
        ...
        loss.backward()
        optimizer.step()
    plt.imsave(f'images/img{epoch}.png',y_pred.detach().cpu().numpy()[0,0,:,0,:],cmap='gray')
    print(epoch_loss)
